            ...
            <div class="col-sm-2">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="{{route('shop.orders', ['sort' => 'earliest_latest'])}}">Date ASC</a>
                        <a class="dropdown-item" href="{{route('shop.orders', ['sort' => 'latest_earliest'])}}">Date DESC</a>
                    </div>
                </div>
            </div>
